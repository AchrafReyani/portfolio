...
export const buttonPrimaryLarge = `${buttonPrimaryBase} inline-flex items-center gap-2 px-6 py-3 font-semibold rounded-md shadow-md whitespace-nowrap`;

export const buttonPrimaryCircular = `${buttonPrimaryBase} rounded-full w-16 aspect-square flex items-center justify-center shrink-0`;
